...
import net.e4net.demo.repository.MembMoneyRepository;
...
public class MembMoneyService {
	
	private final MembMoneyRepository membMoneyRepository;
	...
	// 회원머니 조회 
	public List<MembMoney> findMembMoney(){
